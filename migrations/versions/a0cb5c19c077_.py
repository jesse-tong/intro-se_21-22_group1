...
Revision ID: a0cb5c19c077
Revises: fb54accc42ef
Create Date: 2024-09-01 15:49:18.596729
...
revision = 'a0cb5c19c077'
down_revision = 'fb54accc42ef'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('library_session', schema=None) as batch_op:
        batch_op.add_column(sa.Column('userId', sa.Integer(), nullable=True))
        batch_op.drop_constraint('library_session_ibfk_2', type_='foreignkey')
        batch_op.create_foreign_key(None, 'user', ['userId'], ['id'])
        batch_op.drop_column('userInfoId')
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('library_session', schema=None) as batch_op:
        batch_op.add_column(sa.Column('userInfoId', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True))
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key('library_session_ibfk_2', 'user_info', ['userInfoId'], ['id'])
