...
Revision ID: 1fe8b04e5d47
Revises: 3498e6fc8cb4
Create Date: 2024-08-23 21:20:26.591431
...
revision = '1fe8b04e5d47'
down_revision = '3498e6fc8cb4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('article', schema=None) as batch_op:
        batch_op.add_column(sa.Column('category', sa.String(length=500).with_variant(mysql.NVARCHAR(national=True, length=500), 'mariadb').with_variant(mysql.NVARCHAR(national=True, length=500), 'mysql'), nullable=True))
    ...
    with op.batch_alter_table('user_following', schema=None) as batch_op:
        batch_op.add_column(sa.Column('followedUser', sa.Integer(), nullable=True))
        batch_op.create_foreign_key(None, 'user', ['followedUser'], ['id'])
...
def downgrade():
    ...
    with op.batch_alter_table('user_following', schema=None) as batch_op:
        ...
        batch_op.drop_column('followedUser')
